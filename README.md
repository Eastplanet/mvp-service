...
**프로젝트 개요**:
이 프로젝트는 자율 주행 보드를 활용하여 차량의 무인 주차를 구현하는 서비스입니다. 사용자는 주차장 입구에서 번호판이 자동으로 인식되며, 차량은 자율 주행 보드를 통해 주차 공간으로 이동됩니다. 이 과정에서 사용자는 키오스크를 통해 간단하게 입차 및 출차를 제어할 수 있습니다. 또한 관리자 페이지를 통해 주차장 관리, 멤버 관리, 통계 시각화, 요금 설정 등의 기능을 제공합니다.

**프로젝트 기간**: 2024.07.00 ~ 2024.08.16

**프로젝트 상세 설명**:

1. **Ai를 활용한 번호판 자동 인식**: LPR(License Plate Recognition) 기술을 사용하여 차량 번호판을 자동으로 인식하고 입장 허용.
2. **3단계 자율 주행 보드**: 라인트레이싱과 강화학습한 Ai모델을 사용하여 자율 주행 보드를 사용하여 차량의 무인 주차 및 출차를 구현.
3. **장애물 감지 및 대처**: LiDAR를 활용하여 주차 중 발생할 수 있는 장애물을 감지하고 대처하는 로직 구현.
4. **키오스크 기반 입차/출차**: 키오스크를 통해 사용자 편의를 극대화.
5. **관리자 페이지**: 주차장 관리, 멤버 관리, 통계 시각화, 시스템 설정 등 다양한 관리 기능 제공.
...
- **서비스 목표**:
    ...
    - 무인 주차 시스템을 통해 주차 공간의 효율성을 높이고, 사고를 줄이며 사용자 편의를 증대시키는 서비스 제공.
