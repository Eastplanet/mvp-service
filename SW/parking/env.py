...
class ParkingEnv(AbstractEnv, GoalEnv):
    ...
    def _create_vehicles(self) -> None:
        ...
        for i in range(self.config["controlled_vehicles"]):
            ...
            # 차량 크기 설정
            vehicle.LENGTH = 28  # 길이 설정
            vehicle.WIDTH = 15  # 너비 설정 
            # 차량 환경 설정
        ...
        for vehicle in self.controlled_vehicles:
            ...
            vehicle.goal.LENGTH = 10  # 랜드마크 길이 설정
        ...
        for lane_index in empty_spots:
            ...
            if not is_occupied and not is_goal:
                ...
                # 차량 크기 설정
                obstacle_vehicle.LENGTH = 28  # 길이 설정 (예: 5.0미터)
                obstacle_vehicle.WIDTH = 15  # 너비 설정 (예: 2.0미터)
