...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # 상단 여백
        main_button_layout.addSpacing(int(300 * self.height_ratio))

        # 로고 추가
        self.logo_label = QLabel(self)
        self.logo_pixmap = QPixmap("parking_kiosk/gui/res/mvp-logo.png").scaled(int(600 * self.width_ratio), int(600 * self.height_ratio), Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation)
